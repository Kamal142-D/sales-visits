...
val ThmanyahDisplayFont = FontFamily(
    Font("font/thmanyah_serif_display_medium.otf", FontWeight.Medium),
    Font("font/thmanyah_serif_display_bold.otf", FontWeight.Bold),
    Font("font/thmanyah_serif_display_black.otf", FontWeight.Black),
)

val ThmanyahTextFont = FontFamily(
    Font("font/thmanyah_serif_text_regular.otf", FontWeight.Normal),
    Font("font/thmanyah_serif_text_medium.otf", FontWeight.Medium),
    Font("font/thmanyah_serif_text_bold.otf", FontWeight.Bold),
)

val GoogleSansFlexFont = FontFamily(
    Font("font/google_sans_flex.ttf", FontWeight.Normal),
    Font("font/google_sans_flex.ttf", FontWeight.Medium),
    Font("font/google_sans_flex.ttf", FontWeight.SemiBold),
    Font("font/google_sans_flex.ttf", FontWeight.Bold),
    Font("font/google_sans_flex.ttf", FontWeight.ExtraBold),
)
